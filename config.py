...
class Config(object):
    ...
    # Number of workers to use in Data loading (the data
    # generators) within model design, e.g., as in:
    # torch.utils.data.DataLoader(train_set, batch_size=1, shuffle=True, num_workers=self.config.NUM_WORKERS)
    NUM_WORKERS = 4
